...
@Component({
  selector: 'rideshare-offer-form',
  templateUrl: './rideshare-offer-form.component.html',
  styleUrls: [ './rideshare-offer-form.component.css' ],
  providers: [
    FormContextService
  ]
})
export class RideshareOfferFormComponent extends ListingFormComponent {
